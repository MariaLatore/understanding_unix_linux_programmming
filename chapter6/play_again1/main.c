 ...
 *     method: set tty into char-by-char mode, read char, return resultt
 *     returns: 0=>yes, 1=>no
 *     better: do no echo inapporpriate input
 */
#include<stdio.h>
#include<termios.h>
...
set_crmode ()
/*
 * purpose: put file descriptor 0 (i.3. stdin) into chr-by-chr mode
 * method: use bits in termios
 */
{
  struct termios ttystate;
  tcgetattr (0, &ttystate);	//read curr. setting
  ttystate.c_lflag &= ~ICANON;	//no bufering
