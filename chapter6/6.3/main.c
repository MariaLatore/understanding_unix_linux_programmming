...
int get_ok_char ();
void set_tty_cr_noecho_timeout ();
void tty_mode (int);
...
main ()
{
  ...
  set_tty_cr_noecho_timeout ();	//set -icano, -echo
...
/*
 * purpose: ask a question and wait for a y/n answer of maxtries
