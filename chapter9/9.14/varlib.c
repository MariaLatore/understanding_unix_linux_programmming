 ...
 *     Llookup(name)  returns string or NULL if not there
 ...
 *   environment. It makes seaching pretty easy, as
...
/*
 * traversi list, if found, replaces it, else add at end
...
/*find spot to put_it and make new string*/
 ...
 * returns ptr to struct of NULL if not found
