 ...
 *        utmp_next_active_record() - return pointer to next active result
 *            returns NULL on eof
...
struct utmp *utmp_next_active_record()
{
	struct utmp *recp;
	while(NULLUT != (recp = utmp_next()))
	{
