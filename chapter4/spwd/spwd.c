 ...
 *   lims up to root of filesystem, prints top part
...
void
inum_to_name (ino_t inode_to_find, char *namebuf, int buflen)
/*
 * looks through current directory for a file with this inode
 * number and copying its name into namebuf
 */
{
  DIR *dir_ptr;			//the directoy
